...
class BugdownTest(ZulipTestCase):
    ...
    def test_inline_image_thumbnail_url(self):
        ...
        thumbnail_img = '<img data-original="/thumbnail/user_uploads/2/50/w2G6ok9kr8AMCQCTNAUOFMln/IMG_0677.JPG?size=original" src="/thumbnail/user_uploads/2/50/w2G6ok9kr8AMCQCTNAUOFMln/IMG_0677.JPG?size=thumbnail">'
        converted = bugdown_convert(msg)
        self.assertIn(thumbnail_img, converted)

        msg = 'https://www.google.com/images/srpr/logo4w.png'
        thumbnail_img = '<img data-original="/thumbnail/https%3A//www.google.com/images/srpr/logo4w.png?size=original" src="/thumbnail/https%3A//www.google.com/images/srpr/logo4w.png?size=thumbnail">'
        converted = bugdown_convert(msg)
        self.assertIn(thumbnail_img, converted)

        msg = 'www.google.com/images/srpr/logo4w.png'
        thumbnail_img = '<img data-original="/thumbnail/http%3A//www.google.com/images/srpr/logo4w.png?size=original" src="/thumbnail/http%3A//www.google.com/images/srpr/logo4w.png?size=thumbnail">'
        converted = bugdown_convert(msg)
        self.assertIn(thumbnail_img, converted)
    ...
    def test_inline_image_preview(self):
        # type: () -> None
        with_preview = '<div class="message_inline_image"><a href="http://cdn.wallpapersafari.com/13/6/16eVjx.jpeg" target="_blank" title="http://cdn.wallpapersafari.com/13/6/16eVjx.jpeg"><img data-original="/thumbnail/http%3A//cdn.wallpapersafari.com/13/6/16eVjx.jpeg?size=original" src="/thumbnail/http%3A//cdn.wallpapersafari.com/13/6/16eVjx.jpeg?size=thumbnail"></a></div>'
    ...
    def test_inline_image_preview_order(self) -> None:
        ...
        expected = '<div class="message_inline_image"><a href="http://imaging.nikon.com/lineup/dslr/df/img/sample/img_01.jpg" target="_blank" title="http://imaging.nikon.com/lineup/dslr/df/img/sample/img_01.jpg"><img data-original="/thumbnail/http%3A//imaging.nikon.com/lineup/dslr/df/img/sample/img_01.jpg?size=original" src="/thumbnail/http%3A//imaging.nikon.com/lineup/dslr/df/img/sample/img_01.jpg?size=thumbnail"></a></div><blockquote>\n<div class="message_inline_image"><a href="http://imaging.nikon.com/lineup/dslr/df/img/sample/img_02.jpg" target="_blank" title="http://imaging.nikon.com/lineup/dslr/df/img/sample/img_02.jpg"><img data-original="/thumbnail/http%3A//imaging.nikon.com/lineup/dslr/df/img/sample/img_02.jpg?size=original" src="/thumbnail/http%3A//imaging.nikon.com/lineup/dslr/df/img/sample/img_02.jpg?size=thumbnail"></a></div></blockquote>\n<ul>\n<li><div class="message_inline_image"><a href="http://imaging.nikon.com/lineup/dslr/df/img/sample/img_03.jpg" target="_blank" title="http://imaging.nikon.com/lineup/dslr/df/img/sample/img_03.jpg"><img data-original="/thumbnail/http%3A//imaging.nikon.com/lineup/dslr/df/img/sample/img_03.jpg?size=original" src="/thumbnail/http%3A//imaging.nikon.com/lineup/dslr/df/img/sample/img_03.jpg?size=thumbnail"></a></div></li>\n<li><div class="message_inline_image"><a href="https://www.google.com/images/srpr/logo4w.png" target="_blank" title="https://www.google.com/images/srpr/logo4w.png"><img data-original="/thumbnail/https%3A//www.google.com/images/srpr/logo4w.png?size=original" src="/thumbnail/https%3A//www.google.com/images/srpr/logo4w.png?size=thumbnail"></a></div></li>\n</ul>'
    ...
    def test_image_preview_title(self) -> None:
        ...
        self.assertEqual(
            ...
            '<img data-original="/thumbnail/https%3A//example.com/testimage.png?size=original" src="/thumbnail/https%3A//example.com/testimage.png?size=thumbnail">'
            '</a>'
            '</div>'
        )
